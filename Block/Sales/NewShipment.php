...
use MyParcelCOM\Magento\Model\Source\DefaultOptions;
...
class NewShipment extends AbstractItems
{
    ...
    /**
     * @var \MyParcelCOM\Magento\Model\Source\DefaultOptions
     */
    ...
    public function __construct(
        ...
        $this->defaultOptions = new DefaultOptions(
            $this->order,
            $this->objectManager->get('\MyParcelCOM\Magento\Helper\Data')
        );
